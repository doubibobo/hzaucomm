...
class UserModel extends Model {
    ...
    public function checkName($name, $pwd) {
        // 学生用户表
        $studentUser = M('Student', 'tp_', 'DB_CONFIG2');
        // $studentUser = M("Student");

        // 普通用户表
        $ordinaryUser = M('User', 'tp_', 'DB_CONFIG2');
        // $ordinaryUser = M("User");
    ...
    public function saveRemember($uid, $identifier, $token, $timeout) {
        $stUser = M("Studentlog", "tp_", "DB_CONFIG2");
        // $stUser = M("Studentlog");
    ...
    public function checkUsername($username) {
        $student = M("Student", "tp_", "DB_CONFIG2");
        // $student = M("Student");
    ...
    public function doRegister($info) {
        $ordinary = M("Student", "tp_", "DB_CONFIG2");
        // $ordinary = M("Student");
    ...
    public function subAllUserPwd($oldPwd) {
        ...
        $student = M($database, "tp_", "DB_CONFIG2");
        // $student = M($database);
